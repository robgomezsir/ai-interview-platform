...
// Dados do template com valores em português brasileiro
const templateData = [
    {
        ...
        'Palavras-chave': 'experiência, atendimento, cliente',
        'Prioridade': 1,
        'Ativo': true
    },
    {
    ...
    },
    {
        ...
        'Tipo de Prompt': 'Mensagem Inicial',
...
try {
    ...
    console.log('✅ Template Excel PT-BR criado com sucesso:', excelPath);
